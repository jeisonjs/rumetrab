...
<form id="frm-Registro" action="?c=Registro&a=Guardar" method="post" data-toggle="validffator" enctype="multipart/form-data">
        ...
        <div class="panel-body">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select id="CboDepartamento" name="Departamento_Seq" class="form-control" required>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select id="CboProvincia" name="Provincia_Seq" class="form-control" required>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" name="Organizacion_Pertenece" value="<?php echo $alm->Organizacion_Pertenece; ?>" class="form-control"
          ...
          <div class="panel-body">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <select id="CboEspecialidad" name="Especialedad_Seq" class="form-control" required>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <select id="CboSubEspecialidad" name="SubEspecialidad_Seq" class="form-control" required>
          ...
          <div class="panel-body">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" name="Primer_Apellido" value="<?php echo $alm->Primer_Apellido; ?>" class="form-control" placeholder="Ingrese su apellido"
                    required />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="MainContent_text" class="col-sm-4 control-label" required>Tipo de Documento:</label>
                <div class="col-sm-8">
                ...
                <div class="col-sm-8">
                  <div class='input-group date' id='divMiCalendario'>
                    <span class="input-group-addon">
                      <input type="text" name="Fecha_Nacimiento" value="<?php echo $alm->Fecha_Nacimiento; ?>" class="form-control" required readonly
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" name="Primer_Nombre" value="<?php echo $alm->Primer_Nombre; ?>" class="form-control" placeholder="Ingrese su nombre"
                    required/>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" name="Numero_Documento" value="<?php echo $alm->Numero_Documento; ?>" class="form-control" placeholder="Ingrese su Número de Documento"
                    required/>
                </div>

                <div class="col-sm-4">
                  <select id="CboDepCI" name="Expedido" class="form-control" required>
            ...
            <div class="col-md-12 ">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="Castellano" class="form-control" required>
            ...
            <div class="col-md-12 ">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="Quechua" class="form-control" required>
                      <option value="">Seleccione Idioma...</option>
            ...
            <div class="col-md-12 ">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="Aymara" class="form-control" required>
                      <option value="">Seleccione Idioma...</option>
            ...
            <div class="col-md-12 ">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="Guarani" class="form-control" required>
                      <option value="">Seleccione Idioma...</option>
            ...
            <div class="col-md-12 ">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="Otro" class="form-control" required>
                      <option value="">Seleccione Idioma...</option>
          ...
          <div class="panel-body">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" name="Direccion_vive" value="<?php echo $alm->Direccion_vive; ?>" class="form-control" placeholder="Ingrese su dirección donde vive..."
                    required/>
                </div>
              </div>
              <div class="form-group">
          ...
          <div class="panel-body">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" name="Anos_Experiencia_Especialidad" value="<?php echo $alm->Anos_Experiencia_Especialidad; ?>" maxlength="2"
                    class="form-control" placeholder="Introduzca solo números Ej.: (10) – (20)" required />
                </div>
              </div>
              <div class="form-group">
                <label for="MainContent_text" class="col-sm-4 control-label">Número de Pacientes Ultimo Año(opcional):</label>
                <div class="col-sm-8">
                  <input type="text" name="Numero_Pacientes" value="<?php echo $alm->Numero_Pacientes; ?>" class="form-control" maxlength="4"
                    placeholder="Introduzca Número de Pacientes Ultimo Año" />
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" name="Anos_Experiencia_Sub_Especialidad" value="<?php echo $alm->Anos_Experiencia_Sub_Especialidad; ?>"
                    maxlength="2" class="form-control" placeholder="Introduzca solo números Ej.: (10) – (20)" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="panel-body">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" name="Codigo_Formulario" value="<?php echo $alm->Codigo_Formulario; ?>" class="form-control" placeholder="Ingrese su código de formulario"
                    required />
                </div>
              </div>
            </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <div class='input-group date' id='divMiCalendario2'>
                    <span class="input-group-addon">
                      <input type="text" name="Fecha_Formulario" value="<?php echo $alm->Fecha_Formulario; ?>" class="form-control" required placeholder="Ingrese su fecha del formulario"
                      />
                    </span>
                  </div>
                </div>
      ...
      <div class="form-horizontal">
        <div class="text-center">
          <button class="btn btn-success">
            <img src="imagenes/save.png"> Guardar</button>
          <a class="btn btn-success" href="?c=Registro&a=MT">
            <img src="imagenes/cancel.png"> Cancelar</a>
        </div>
      </div>
      <br/>
    </div>
...
echo ("Según la PC la hora actual es: ". date("H:i:s",time()-3909600));
...
echo ("Fecha actual es: ". date("d-m-Y ", $time));
