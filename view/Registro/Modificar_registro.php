        ...
        <div class="col-md-6">
            <div class="form-group">
               <label for="MainContent_text" class="col-sm-4 control-label">Primer Apellido:</label>
                <div class="col-sm-8">
                  <input type="text" name="Primer_Apellido" value="<?php echo $alm->Primer_Apellido; ?>" class="form-control" placeholder="Ingrese su apellido" required />
                </div>
            </div>
            <div class="form-group">
           ...
           <div class="col-sm-8">
                      ...
                      <span class="input-group-addon">
                        <input type="text" name="Fecha_Nacimiento" value="<?php echo $alm->Fecha_Nacimiento; ?>" class="form-control"  required placeholder="Ingrese su fecha de nacimiento"/>
                     </span>
                    </div>
                  </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
              <label for="MainContent_text" class="col-sm-4 control-label">Primer Nombre:</label>
                <div class="col-sm-8">
                   <input type="text" name="Primer_Nombre" value="<?php echo $alm->Primer_Nombre; ?>" class="form-control" placeholder="Ingrese su nombre" required/>        
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <label for="MainContent_text" class="col-sm-4 control-label">Número de Documento:</label>
               <div class="col-sm-4">
                 <input type="text" name="Numero_Documento" value="<?php echo $alm->Numero_Documento; ?>" class="form-control" placeholder="Ingrese su Número de Documento" required/>        
               </div>

                <div class="col-sm-4">
                 <select id="CboDepartamentoCI" name="Expedido"  class="form-control" required>
        ...
        <div class="col-md-6">
            <div class="form-group">
               <label for="MainContent_text" class="col-sm-4 control-label">Dirección donde vive actualmente:</label>
                <div class="col-sm-8">
                  <input type="text" name="Direccion_vive" value="<?php echo $alm->Direccion_vive; ?>" class="form-control" placeholder="Ingrese su dirección donde vive..." required />
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
               <label for="MainContent_text" class="col-sm-4 control-label">Años de Experiencia de Especialidad:</label>
                <div class="col-sm-8">
                  <input type="text" name="Anos_Experiencia_Especialidad" value="<?php echo $alm->Anos_Experiencia_Especialidad; ?>" maxlength="2" class="form-control" placeholder="Introduzca solo números Ej.: (10) – (20)" required/>
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
               <label for="MainContent_text" class="col-sm-4 control-label">Código de Formulario:</label>
                <div class="col-sm-8">
                  <input type="text" name="Codigo_Formulario" value="<?php echo $alm->Codigo_Formulario; ?>" class="form-control" placeholder="Ingrese su código de formulario" required />
                </div>
            </div>
        </div>
        <div class="col-md-6">
 ...
 <div class="container-fluid" >
  <div class="container-fluid" style="border-width:4px; border-style: groove; border-color: #e4e8ec">
   ...
   <div class="panel-body">
        <div class="col-md-6">
            <div class="form-group">
               <label for="MainContent_text" class="col-sm-4 control-label">hora de Registro:</label>
                <div class="col-sm-8">
        ...
        <div class="col-md-6">
             <div class="form-group">
               <label for="MainContent_text" class="col-sm-4 control-label">fecha de Registro:</label>
                <div class="col-sm-8">
